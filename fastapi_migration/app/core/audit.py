...
class AuditLog(Base):
    ...
    # Event details
    event_type = Column(String, nullable=False, index=True)  # LOGIN, PASSWORD_RESET, DATA_RESET, etc.
    action = Column(String, nullable=False)  # specific action description
    ...
    # Status
    success = Column(String, nullable=False)  # SUCCESS, FAILED, PARTIAL
...
class AuditLogger:
    ...
    def _create_audit_log(
        ...
        try:
            ...
            logger.info(f"Audit log created: {event_type}:{action} by {user_email}")
            return audit_log
