...
Revision ID: 4a99b022a3ae
Revises: 
Create Date: 2025-07-31 14:12:42.512042
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('contra_vouchers', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_contra_vouchers_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('credit_notes', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_credit_notes_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('debit_notes', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_debit_notes_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('inter_department_vouchers', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_inter_department_vouchers_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('journal_vouchers', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_journal_vouchers_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('payment_vouchers', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_payment_vouchers_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('proforma_invoices', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_proforma_invoices_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('purchase_orders', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_purchase_orders_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('quotations', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_quotations_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('receipt_vouchers', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_receipt_vouchers_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('sales_orders', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_sales_orders_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('delivery_challans', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_delivery_challans_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('goods_receipt_notes', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_goods_receipt_notes_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('purchase_vouchers', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_purchase_vouchers_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('sales_vouchers', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_sales_vouchers_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('purchase_returns', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_purchase_returns_voucher_number'), ['voucher_number'], unique=True)
    ...
    with op.batch_alter_table('sales_returns', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_sales_returns_voucher_number'), ['voucher_number'], unique=True)
