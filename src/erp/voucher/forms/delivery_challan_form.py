# src/erp/voucher/forms/delivery_challan_form.py

from src.erp.logic.utils.forms_utils import *
from src.erp.logic.utils.sequence_utils import get_next_delivery_challan_sequence, increment_delivery_challan_sequence

class DeliveryChallanForm(QWidget):
    def __init__(self, parent=None, app=None, module_name=None, voucher_type_id=None, voucher_type_name=None, voucher_data=None, voucher_management=None, voucher_category=None, voucher_name=None, save_callback=None, add_product_callback=None, entities=None, products=None, payment_terms=None):
        ...
        self.voucher_type_name = voucher_type_name if voucher_type_name else "Delivery Challan"
        ...
        self.setObjectName("DeliveryChallanForm")
        apply_stylesheet(self, "delivery_challan_form.qss")
        self.setup_ui()

    def setup_ui(self):
        logger.info(f"Creating Delivery Challan form (ID: {self.voucher_type_id})")
        ...
        # Title
        title_label = create_title_label("Create Delivery Challan")
        self.content_layout.addWidget(title_label)

        # Header row: Voucher Number, Date
        header_fields = [
            ("Voucher Number*", 'text', "Voucher Number", get_next_delivery_challan_sequence() or ''),
    ...
    def save_voucher(self):
        save_voucher(self, ["Voucher Number", "Voucher Date", "Party Name"], increment_delivery_challan_sequence, stock_check=True, stock_update=True)